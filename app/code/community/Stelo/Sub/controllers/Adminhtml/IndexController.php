...
class Stelo_Sub_Adminhtml_IndexController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        $return = Mage::getModel('sub/api')->checkStatus();
    ...
    public function cancelorderAction()
    {
        ...
        if(isset($par['orderid'])){
            ...
            $return = Mage::getModel('sub/api')->cancelOrder($par['orderid']);
